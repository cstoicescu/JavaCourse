...
public class Demo {
    public static void main(String[] args) {
        ...
        addInOrder(placeToVisit, "Brisbanne");
...
//        printList(placeToVisit);
    ...
    private static boolean addInOrder(LinkedList<String> linkedList, String newCity) {
        ...
        while (listIterator.hasNext()) {
            ...
            if (comparison == 0) {
                //do not add
                System.out.println(newCity + " is already on the LinkedList");
                return false;
        ...
        listIterator.add(newCity);
        System.out.println(newCity + " added on the LinkedList");
        return true;
    }
